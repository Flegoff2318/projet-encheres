			...
			<div class="grid">
				<div class="row mt-5 justify-content-md-center">
					...
					<div class="col col-lg-4">
						...
						<div class="row mt-5 justify-content-md-center">
						<c:if test="${utilisateur != article.utilisateur && article.etatVente==1}">
							<form action="" method="post">
								<label class="ml-3" for="proposition">Ma proposition : </label>
								<input class="ml-3" type="number" id="proposition"
									name="proposition" min="${enchere>0?enchere+1:article.miseAPrix+1}" 
									value="${enchere>0?enchere+1:article.miseAPrix+1}">
